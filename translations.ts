...
const trustSection = {
    ...
    trust_feature_2_title: {
        en: "Powered by Google AI",
        es: "Impulsado por la IA de Google",
        ar: "مدعوم بالذكاء الاصطناعي من جوجل",
        zh: "由 Google 人工智能提供支持",
    },
    trust_feature_2_desc: {
        en: "Our analysis is powered by Google's cutting-edge Gemini model, providing world-class intelligence to decipher complex legal text.",
        es: "Nuestro análisis está impulsado por el modelo Gemini de vanguardia de Google, que proporciona inteligencia de clase mundial para descifrar textos legales complejos.",
        ar: "تحليلنا مدعوم بنموذج Gemini المتطور من جوجل، مما يوفر ذكاءً عالمي المستوى لفك شفرة النصوص القانونية المعقدة.",
        zh: "我们的分析由 Google 尖端的 Gemini 模型提供支持，提供世界一流的智能来解读复杂的法律文本。",
    },
...
const faqSection = {
    ...
    faq_a2: {
        en: "Our contract analysis AI is powered by Google's state-of-the-art Gemini model. When you upload or paste a document, the AI performs a deep artificial intelligence contract analysis, breaking down the text into key components like strengths, weaknesses, red flags, and negotiation points, presenting them in an easy-to-understand report.",
        es: "Nuestra IA de análisis de contratos está impulsada por el modelo Gemini de última generación de Google. Cuando subes o pegas un documento, la IA realiza un análisis profundo de contratos con inteligencia artificial, desglosando el texto en componentes clave como fortalezas, debilidades, señales de alerta y puntos de negociación, presentándolos en un informe fácil de entender.",
        ar: "يتم تشغيل الذكاء الاصطناعي الخاص بنا لتحليل العقود بواسطة نموذج Gemini المتطور من Google. عندما تقوم بتحميل أو لصق مستند، يقوم الذكاء الاصطناعي بإجراء تحليل عميق للعقد بالذكاء الاصطناعي، وتقسيم النص إلى مكونات رئيسية مثل نقاط القوة والضعف والعلامات الحمراء ونقاط التفاوض، وتقديمها في تقرير سهل الفهم.",
        zh: "我们的合同分析人工智能由谷歌最先进的 Gemini 模型提供支持。当您上传或粘贴文档时，人工智能会执行深度人工智能合同分析，将文本分解为优势、劣势、危险信号和谈判要点等关键组成部分，并以易于理解的报告形式呈现。",
    },
